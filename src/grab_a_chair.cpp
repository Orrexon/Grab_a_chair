...
int main(int, char**)
{
    ...
    app_state Restaurant = InitRestaurant();
    ...
    while (!done)
    {
        ...
        ResturantEventDeQueue(&Restaurant);
        // NOTE(Oscar): APP GOES HERE!
        Update(&Restaurant);
        
        if(Restaurant.PopupBookMenu)
        {
            AddEventToEventQueue(RESTAURANT_EVENT_QUEUE_POPUP_BOOKING_WINDOW);
        }
